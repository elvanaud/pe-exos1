...
print(array)
print(array.dtype) #U32 : chaine de 32 caractères unicodes

# %%
df = pd.DataFrame(array, columns=['names', 'speed', 'lifespan'])
df[df['names'] == 'elephant']['lifespan'] #type 'object': interprêté comme une chaine de caractères

# %%
df[df['names'] == 'elephant']['names'] #type 'object': comme ci dessus

# %%
df.iloc[2]['names'] = 'grey elephant'
print(df.iloc[2]['names'])
type(df.iloc[2]['names']) #type python str

# %%
df.dtypes

# %%
df.to_numpy() #contient désormais des 'object' de pandas
